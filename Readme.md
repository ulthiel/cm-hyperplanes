...
| $\Gamma$       | $\|\mathcal{E}\|$ | $\mathrm{dim} \mathfrak{c}_{\mathbb{Q}}$ | $W$                                                          | $\pi(t)$                                                            | $E$     | free | ss  | $K(\pi,1)$ |
| -------------- | ----------------- | ---------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------------- | ------- | ---- | --- | ---------- |
| $G_{4}$        | 6                 | 2                                        | $\mathfrak{S}_3$                                             | $(5t+1)(t+1)$                                                       | 2       | yes  | yes | yes        |
...
| $F_{4}=G_{28}$ | 8                 | 2                                        | $\mathfrak{S}_2 \times \mathfrak{S}_2$                       | $(7t+1)(t+1)$                                                       | 4       | yes  | yes | yes        |
